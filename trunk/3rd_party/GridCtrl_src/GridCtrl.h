...
public:
	...
	void SetClickCallbackFunc(GRIDCALLBACK pCallback, 
						LPARAM lParam)			  {m_pfnClickback=pCallback;m_lClickParam=lParam;}
...
public:
	...
	//seven add-01/07/2012 to support set value for specific cell
	//BOOL   SetCellItem(int nRow, int)
...
public:
	...
	//check grid state
	BOOL IsGridLoadComplete()        {return m_bGridDrawDone;}
...
protected:
	...
	//call back for gird clik-by seven
	LPARAM      m_lClickParam;
	GRIDCALLBACK m_pfnClickback;
