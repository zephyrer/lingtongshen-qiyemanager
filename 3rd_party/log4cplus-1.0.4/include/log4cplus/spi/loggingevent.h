...
namespace log4cplus {
    namespace spi {
          ...
          // Ctors
             ...
             InternalLoggingEvent(const log4cplus::tstring& logger,
              ...
              : message(message_),
                ...
                ll(ll_),
                ndc(),
                thread(log4cplus::helpers::convertIntegerToString(GetCurrentThreadId())),
			 ...
			 InternalLoggingEvent(const log4cplus::tstring& logger,
				 ...
				 ll(ll_),
				 ndc(),
				 thread(log4cplus::helpers::convertIntegerToString(thread_)),
				 process(process_),
				 timestamp(log4cplus::helpers::Time::gettimeofday()),
				 file( (  filename
				 ? LOG4CPLUS_C_STR_TO_TSTRING(filename) 
	     ...
	     */
			...
			/** The process in which this logging event was generated. */
